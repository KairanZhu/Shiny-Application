...
The application "Millennium Development Goals (MDGs)" is deployed here: https://penguinkason.shinyapps.io/Shiny_Project/

The dataset used and source code for ui.R and server.R files can be found here: https://github.com/KairanZhu/Shiny-Application
